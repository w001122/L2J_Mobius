...
import com.l2jmobius.gameserver.model.events.impl.creature.player.OnPlayerAugment;
import com.l2jmobius.gameserver.model.events.impl.creature.player.inventory.OnPlayerItemDrop;
import com.l2jmobius.gameserver.model.events.impl.creature.player.inventory.OnPlayerItemPickup;
...
public final class ItemInstance extends WorldObject
{
	...
	public final void pickupMe(Creature creature)
	{
		...
		if (!Config.DISABLE_TUTORIAL && ((_itemId == ADENA_ID) || (_itemId == 6353)))
		{
			// Note from UnAfraid:
			// Unhardcode this?
			final PlayerInstance actor = creature.getActingPlayer();
			if (actor != null)
			{
