...
public class ClanHallDoormanInstance extends DoormanInstance
{
	 ...
	 */
	public ClanHallDoormanInstance(NpcTemplate template)
	{
		super(template);
		setInstanceType(InstanceType.ClanHallDoormanInstance);
	}
